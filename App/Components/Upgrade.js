...
const Upgrade = (props) => {
  ...
  const playSound = async () => {
    ...
    try{
      await soundPageTurn.loadAsync(require('../../assets/Sounds/126422__cabeeno-rossley__level-up.wav'))
  ...
  return (
    <TouchableHighlight
      style= {(isUpgradeAvailable(upgrade))? styles.usableUpgradeBtn : styles.unusableUpgradeBtn}
...
const styles = StyleSheet.create({
  usableUpgradeBtn: { height: 50, width: 200, margin: 5, borderColor: "blue", borderWidth: 1 },
  unusableUpgradeBtn: { height: 50, width: 200, margin: 5, borderColor: "red", borderWidth: 1 },
